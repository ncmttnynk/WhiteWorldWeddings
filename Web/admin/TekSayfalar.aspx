<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MP_Admin.master" AutoEventWireup="true" CodeFile="TekSayfalar.aspx.cs" Inherits="TekSayfalar" %>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10" id="divFotoUpload" runat="server">
                                    <asp:Button ID="btnFotografUpload" OnClick="btnUpload_Click" runat="server" CssClass="btn btn-primary" Style="visibility: hidden; display: none;" Text="xxx" />
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="İşlemler" HeaderStyle-Width="220" ItemStyle-Width="220" ItemStyle-CssClass="center" HeaderStyle-CssClass="center">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="hlGit" runat="server" NavigateUrl='<%#string.Format("/"+Dil+"/{0},onepage",Eval("Kod"))%>' ToolTip="Göster" Target="_blank"><i class="fa fa-link" aria-hidden="true"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
