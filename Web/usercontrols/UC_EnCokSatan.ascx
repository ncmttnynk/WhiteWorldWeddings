<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_EnCokSatan.ascx.cs" Inherits="usercontrols_UC_UrunListesi_EnCokSatan" %>
    ...
    <div class="container">
        <div class="tab-product style2 tab-owl-fade-effect">
            <ul class="box-tabs nav-tab">
                <li class="text-head"><%=Dil.Equals("tr") ? "E" : "B" %></li>
                <li class="active"><a data-toggle="tab" href="#enCokSatan"><%=Dil.Equals("tr") ? "En Çok Satan" : "Best Seller" %></a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-container">
                    <asp:Repeater ID="rptEnCokSatan" runat="server" OnItemDataBound="rptEnCokSatan_ItemDataBound">
                        <HeaderTemplate>
                            <div id="enCokSatan" class="tab-panel active">
