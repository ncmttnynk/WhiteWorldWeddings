<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_YeniSezon.ascx.cs" Inherits="usercontrols_UC_UrunListesi_YeniSezon" %>
    ...
    <div class="container">
        <div class="tab-product style2 tab-owl-fade-effect">
            <ul class="box-tabs nav-tab">
                <li class="text-head"><%=Dil.Equals("tr") ? "Y" : "F" %></li>
                <li class="active"><a data-toggle="tab" href="#yeniSezon"><%=Dil.Equals("tr") ? "Yeni Sezon" : "New Season" %></a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-container">
                    <asp:Repeater ID="rptYeniSezon" runat="server" OnItemDataBound="rptYeniSezon_ItemDataBound">
                        <HeaderTemplate>
                            <div id="yeniSezon" class="tab-panelactive">
