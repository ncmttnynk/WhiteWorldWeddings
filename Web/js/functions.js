    ...
    function init_popup(){
        if($(window).width() + boutique_get_scrollbar_width() >= 768){
            if($('body').hasClass('home')){
                ...
                $.magnificPopup.open({
                  items: {
                      src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><h3>White World Weddings</h3><img src="/images/logo.png" alt=""><blockquote>Deðerli Müþterilerimiz; White House olarak bütün dünyayý etkisi altýna alan ve ne yazýk ki Türkiye"ye de sýçramýþ olan Corona Virüs (COVID-19) salgýgýna dair bütün geliþmeleri ilk günden itibaren yakýndan takip ediyor ve gerekli bütün önlemleri alýyoruz. 23 Mart itibariyle toptan, perakende maðazalarýmýzdaki ve üretim merkezlerimizdeki hizmetlerimize geçici olarak ara vermiþ bulunmaktayýz. Saðlýklý günlerde buluþmak dileðiyle...</blockquote></div></div></div>',  //can be a HTML string, jQuery object, or CSS selector
                    type: 'inline'
                  }
                });
            }
